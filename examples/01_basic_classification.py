...
def main():
    ...
    print(f"   {'Test Accuracy':<25} {test_acc_no_prune:<15.4f} {test_acc_prune:<15.4f} {test_acc_change:+.4f}")
    print(f"   {'Tree Depth':<25} {clf_no_prune.get_depth():<15} {clf_with_prune.get_depth():<15} {clf_with_prune.get_depth() - clf_no_prune.get_depth():+}")
    print(f"   {'Number of Nodes':<25} {clf_no_prune.tree_.count_nodes():<15} {clf_with_prune.tree_.count_nodes():<15} {-node_reduction:+}")
