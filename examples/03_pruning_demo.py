...
from reptree.utils import train_test_split, export_text, export_dict, plot_tree_stats
from reptree.pruning.rep import ReducedErrorPruner
...
def main():
    ...
    print("   " + "-" * 70)
    print(f"   {'Nodes':<30} {nodes_before:<15} {nodes_after:<15} {-nodes_removed} ({-nodes_removed_pct:.1f}%)")
    ...
    print(f"   {'Train Accuracy':<30} {train_acc_before:<15.4f} {train_acc_after:<15.4f} {train_acc_after - train_acc_before:+.4f}")
    print(f"   {'Validation Accuracy':<30} {val_acc_before:<15.4f} {val_acc_after:<15.4f} {val_acc_after - val_acc_before:+.4f}")
    print(f"   {'Test Accuracy':<30} {test_acc_before:<15.4f} {test_acc_after:<15.4f} {test_acc_after - test_acc_before:+.4f}")
    ...
    for min_samples in min_samples_values:
        ...
        print(f"   min_samples_split={min_samples:2d}: "
