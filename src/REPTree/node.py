...
class TreeNode:
    ...
    __slots__ = (
        'node_id', 'parent', 'feature_index', 'threshold',
        '_left', '_right', 'value', 'samples', 'impurity'
    )
    ...
    def predict_batch(self, X: np.ndarray) -> np.ndarray:
        ...
        if np.any(missing_mask):
            ...
            if self._left and self._right:
                larger_child = self._left if self._left.samples >= self._right.samples else self._right
