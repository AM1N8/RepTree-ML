...
import pytest
import numpy as np
from reptree.metrics import (
    gini_impurity, entropy, variance, mae_impurity,
    information_gain, accuracy_score, mean_squared_error,
...
class TestClassificationMetrics:
    ...
    def test_confusion_matrix_binary(self):
        ...
        expected = np.array([
            [1, 1],  # True 0: predicted 0, predicted 1
            [1, 1]   # True 1: predicted 0, predicted 1
        ])
